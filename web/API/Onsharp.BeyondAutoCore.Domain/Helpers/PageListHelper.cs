namespace Onsharp.BeyondAutoCore.Domain.Helpers
{
    public class PageList<T> : List<T>
    {
        ...
        public PageList(List<T> items, int count, int pageNumber, int pageSize, int totalEntries)
        {
            TotalCount = count;
        ...
        public static PageList<T> Create(List<T> items, int count, int pageNumber, int pageSize)
        {
            return new PageList<T>(items, count, pageNumber, pageSize);
        }
