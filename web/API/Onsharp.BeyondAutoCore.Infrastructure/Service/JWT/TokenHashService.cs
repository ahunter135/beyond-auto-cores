...
namespace Onsharp.BeyondAutoCore.Infrastructure.Service.JWT
{
    public class TokenHashService : ITokenHashService
    {
        ...
        //    byte[] hash = ComputePBKDF2(password, salt, PBKDF2_ITERATIONS, HASH_BYTE_SIZE);
        ...
        public bool ValidatePassword(string password, string correctHash)
        {
            try
            {
                // little sanity check for users who dont have a password set yet.
                if (correctHash == null) return false;
                if (correctHash.Length == 0) return false;
                ...
                byte[] testHash = ComputePBKDF2(password, salt, iterations, hash.Length);
